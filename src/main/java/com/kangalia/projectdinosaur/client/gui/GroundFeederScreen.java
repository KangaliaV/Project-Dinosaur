...
public class GroundFeederScreen extends AbstractContainerScreen<GroundFeederContainer> {
    ...
    protected void renderBg(PoseStack stack, float partialTicks, int x, int y) {
        ...
        this.blit(stack,i+72, j+66-herbiFillHeight, 176, 32-herbiFillHeight, 6, herbiFillHeight);
        this.blit(stack,i+85, j+66-carniFillHeight, 176, 32-carniFillHeight, 6, carniFillHeight);
        this.blit(stack,i+98, j+66-pisciFillHeight, 176, 32-pisciFillHeight, 6, pisciFillHeight);
