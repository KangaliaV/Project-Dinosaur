...
public class GroundFeederContainer extends AbstractContainerMenu {
    public BlockEntity tileEntity;
    private final Player playerEntity;
    private final IItemHandler playerInventory;

    public GroundFeederContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(ContainerInit.GROUND_FEEDER_CONTAINER.get(), windowId);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(tileEntity.getLevel(), tileEntity.getBlockPos()), playerIn, BlockInit.GROUND_FEEDER.get());
    }
