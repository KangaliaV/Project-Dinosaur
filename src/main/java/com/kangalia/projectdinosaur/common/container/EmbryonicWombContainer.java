...
public class EmbryonicWombContainer extends AbstractContainerMenu {
    public BlockEntity tileEntity;
    private final Player playerEntity;
    private final IItemHandler playerInventory;

    public EmbryonicWombContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(ContainerInit.EMBRYONIC_WOMB_CONTAINER.get(), windowId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(tileEntity.getLevel(), tileEntity.getBlockPos()), pPlayer, BlockInit.EMBRYONIC_WOMB.get());
    }
