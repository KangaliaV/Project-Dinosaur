...
public class AustralovenatorEggBlockEntity extends BlockEntity {

    private String parent1 = "";
    private String parent2 = "";

    public AustralovenatorEggBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(BlockEntitiesInit.AUSTRALOVENATOR_EGG_ENTITY.get(), pPos, pBlockState);
    }
