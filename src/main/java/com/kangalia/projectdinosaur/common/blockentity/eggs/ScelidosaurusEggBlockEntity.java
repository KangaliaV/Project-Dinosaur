...
public class ScelidosaurusEggBlockEntity extends BlockEntity {

    private String parent1 = "";
    private String parent2 = "";

    public ScelidosaurusEggBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(BlockEntitiesInit.SCELIDOSAURUS_EGG_ENTITY.get(), pPos, pBlockState);
    }
