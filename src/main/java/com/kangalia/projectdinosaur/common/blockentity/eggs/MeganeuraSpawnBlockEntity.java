...
public class MeganeuraSpawnBlockEntity extends BlockEntity {

    private String parent1 = "";
    private String parent2 = "";

    public MeganeuraSpawnBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(BlockEntitiesInit.MEGANEURA_SPAWN_ENTITY.get(), pPos, pBlockState);
    }
