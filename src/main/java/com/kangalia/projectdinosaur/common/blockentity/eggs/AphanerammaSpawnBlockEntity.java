...
public class AphanerammaSpawnBlockEntity extends BlockEntity {

    private String parent1 = "";
    private String parent2 = "";

    public AphanerammaSpawnBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(BlockEntitiesInit.APHANERAMMA_SPAWN_ENTITY.get(), pPos, pBlockState);
    }
