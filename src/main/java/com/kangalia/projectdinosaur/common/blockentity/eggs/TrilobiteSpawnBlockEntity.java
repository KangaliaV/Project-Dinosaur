...
public class TrilobiteSpawnBlockEntity extends BlockEntity {

    private String parent1 = "";
    private String parent2 = "";

    public TrilobiteSpawnBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(BlockEntitiesInit.TRILOBITE_SPAWN_ENTITY.get(), pPos, pBlockState);
    }
