...
public class GnawingRockBlock extends EnrichmentBlock {
    private static final VoxelShape SHAPE = Block.box(1, 0, 1, 14, 6, 14);

    public GnawingRockBlock(Properties p_49795_) {
        super(p_49795_);
    }
