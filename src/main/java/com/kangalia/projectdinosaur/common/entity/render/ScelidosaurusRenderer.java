...
public class ScelidosaurusRenderer extends GeoEntityRenderer<ScelidosaurusEntity> {
    ...
    @Override
    public void render(GeoModel model, ScelidosaurusEntity animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
