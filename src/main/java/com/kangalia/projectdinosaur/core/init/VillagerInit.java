...
public class VillagerInit {
    ...
    public static final RegistryObject<PoiType> KEEPER_POI = POI_TYPES.register("keeper_poi", () ->
            new PoiType(ImmutableSet.copyOf(BlockInit.INCUBATOR.get().getStateDefinition().getPossibleStates()),
                    1, 1));
    ...
    public static final RegistryObject<VillagerProfession> KEEPER = VILLAGER_PROFESSIONS.register("keeper", () ->
            new VillagerProfession("keeper", holder -> holder.get() == KEEPER_POI.get(), holder -> holder.get() == KEEPER_POI.get(),
