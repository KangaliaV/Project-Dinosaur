...
public class ItemInit {
    ...
    public static final RegistryObject<ForgeSpawnEggItem> GASTORNIS_SPAWN_EGG = ITEMS.register("gastornis_spawn_egg", () -> new PrehistoricSpawnEgg(EntityInit.GASTORNIS, 0x433727, 0x938878, new Item.Properties().stacksTo(64).tab(DinoSpawnEggs.DINO_SPAWN_EGGS)));
