...
public class ItemInit {
    ...
    public static final RegistryObject<Item> CRYOPORTER = ITEMS.register("cryoporter", () -> new Cryoporter(new Item.Properties().stacksTo(1).durability(16).tab(DinoItems.DINO_ITEMS)));
