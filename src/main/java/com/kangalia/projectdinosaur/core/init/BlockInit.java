...
public class BlockInit {
    ...
    public static final RegistryObject<Block> INCUBATED_GASTORNIS_EGG_INCUBATED = registerEggBlock("gastornis_egg_incubated", () -> new Block(BlockBehaviour.Properties.of(Material.EGG, MaterialColor.COLOR_ORANGE).strength(0.5F).sound(SoundType.METAL).randomTicks().noOcclusion()));
    public static final RegistryObject<Block> INCUBATED_GORGONOPS_EGG_INCUBATED = registerEggBlock("gorgonops_egg_incubated", () -> new Block(BlockBehaviour.Properties.of(Material.EGG, MaterialColor.COLOR_ORANGE).strength(0.5F).sound(SoundType.METAL).randomTicks().noOcclusion()));
