...
public class BlockInit {
    ...
    public static final RegistryObject<Block> PETRIFIED_BUTTON = registerBlock("petrified_button", () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.WOOD), BlockSetTypesInit.PETRIFIED_TYPE, 30, true));
    ...
    public static final RegistryObject<Block> PERMIAN_FOSSIL = registerBlock("permian_fossil", () -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(3.0f, 3.0f).sound(SoundType.DEEPSLATE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> CARBONIFEROUS_FOSSIL = registerBlock("carboniferous_fossil", () -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(3.0f, 3.0f).sound(SoundType.DEEPSLATE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> DEVONIAN_FOSSIL = registerBlock("devonian_fossil", () -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(3.0f, 3.0f).sound(SoundType.DEEPSLATE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> SILURIAN_FOSSIL = registerBlock("silurian_fossil", () -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(3.0f, 3.0f).sound(SoundType.DEEPSLATE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> ORDOVICIAN_FOSSIL = registerBlock("ordovician_fossil", () -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(3.0f, 3.0f).sound(SoundType.DEEPSLATE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> CAMBRIAN_FOSSIL = registerBlock("cambrian_fossil", () -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(3.0f, 3.0f).sound(SoundType.DEEPSLATE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> PERMIAN_FOSSIL_ENCASED = registerBlock("permian_fossil_encased", () -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(3.0f, 3.0f).sound(SoundType.DEEPSLATE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> CARBONIFEROUS_FOSSIL_ENCASED = registerBlock("carboniferous_fossil_encased", () -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(3.0f, 3.0f).sound(SoundType.DEEPSLATE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> DEVONIAN_FOSSIL_ENCASED = registerBlock("devonian_fossil_encased", () -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(3.0f, 3.0f).sound(SoundType.DEEPSLATE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> SILURIAN_FOSSIL_ENCASED = registerBlock("silurian_fossil_encased", () -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(3.0f, 3.0f).sound(SoundType.DEEPSLATE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> ORDOVICIAN_FOSSIL_ENCASED = registerBlock("ordovician_fossil_encased", () -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(3.0f, 3.0f).sound(SoundType.DEEPSLATE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> CAMBRIAN_FOSSIL_ENCASED = registerBlock("cambrian_fossil_encased", () -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(3.0f, 3.0f).sound(SoundType.DEEPSLATE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> GNAWING_ROCK_BLACKSTONE = registerBlock("gnawing_rock_blackstone", () -> new GnawingRockBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(2.0F).sound(SoundType.STONE).noOcclusion()));
    public static final RegistryObject<Block> GNAWING_ROCK_CALCITE = registerBlock("gnawing_rock_calcite", () -> new GnawingRockBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(2.0F).sound(SoundType.STONE).noOcclusion()));
    public static final RegistryObject<Block> GNAWING_ROCK_COBBLED_DEEPSLATE = registerBlock("gnawing_rock_cobbled_deepslate", () -> new GnawingRockBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(2.0F).sound(SoundType.STONE).noOcclusion()));
    public static final RegistryObject<Block> GNAWING_ROCK_COBBLESTONE = registerBlock("gnawing_rock_cobblestone", () -> new GnawingRockBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(2.0F).sound(SoundType.STONE).noOcclusion()));
    public static final RegistryObject<Block> GNAWING_ROCK_SANDSTONE = registerBlock("gnawing_rock_sandstone", () -> new GnawingRockBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(2.0F).sound(SoundType.STONE).noOcclusion()));
    public static final RegistryObject<Block> GNAWING_ROCK_RED_SANDSTONE = registerBlock("gnawing_rock_red_sandstone", () -> new GnawingRockBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(2.0F).sound(SoundType.STONE).noOcclusion()));
    public static final RegistryObject<Block> GNAWING_ROCK_TUFF = registerBlock("gnawing_rock_tuff", () -> new GnawingRockBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).strength(2.0F).sound(SoundType.STONE).noOcclusion()));
    ...
    //Incubated Eggs
    public static final RegistryObject<Block> AUSTRALOVENATOR_EGG_INCUBATED = registerEggBlock("australovenator_egg_incubated", () -> new AustralovenatorEggBlock(BlockBehaviour.Properties.of(Material.EGG, MaterialColor.COLOR_ORANGE).strength(0.5F).sound(SoundType.METAL).randomTicks().noOcclusion(), EntityInit.AUSTRALOVENATOR, 3));
    public static final RegistryObject<Block> GASTORNIS_EGG_INCUBATED = registerEggBlock("gastornis_egg_incubated", () -> new GastornisEggBlock(BlockBehaviour.Properties.of(Material.EGG, MaterialColor.COLOR_ORANGE).strength(0.5F).sound(SoundType.METAL).randomTicks().noOcclusion(), EntityInit.GASTORNIS, 4));
    public static final RegistryObject<Block> GORGONOPS_EGG_INCUBATED = registerEggBlock("gorgonops_egg_incubated", () -> new Block(BlockBehaviour.Properties.of(Material.EGG, MaterialColor.COLOR_ORANGE).strength(0.5F).sound(SoundType.METAL).randomTicks().noOcclusion()));
    public static final RegistryObject<Block> SCELIDOSAURUS_EGG_INCUBATED = registerEggBlock("scelidosaurus_egg_incubated", () -> new ScelidosaurusEggBlock(BlockBehaviour.Properties.of(Material.EGG, MaterialColor.COLOR_RED).strength(0.5F).sound(SoundType.METAL).randomTicks().noOcclusion(), EntityInit.SCELIDOSAURUS, 4));
