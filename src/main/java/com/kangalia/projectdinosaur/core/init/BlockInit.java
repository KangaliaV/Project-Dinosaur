...
public class BlockInit {
    ...
    //Incubated Eggs
    public static final RegistryObject<Block> AUSTRALOVENATOR_EGG_INCUBATED = registerEggBlock("australovenator_egg_incubated", () -> new PrehistoricEggBlock(BlockBehaviour.Properties.of(Material.EGG, MaterialColor.COLOR_ORANGE).strength(0.5F).sound(SoundType.METAL).randomTicks().noOcclusion(), EntityInit.AUSTRALOVENATOR, 3));
    public static final RegistryObject<Block> GASTORNIS_EGG_INCUBATED = registerEggBlock("gastornis_egg_incubated", () -> new PrehistoricEggBlock(BlockBehaviour.Properties.of(Material.EGG, MaterialColor.COLOR_ORANGE).strength(0.5F).sound(SoundType.METAL).randomTicks().noOcclusion(), EntityInit.GASTORNIS, 4));
    ...
    public static final RegistryObject<Block> SCELIDOSAURUS_EGG_INCUBATED = registerEggBlock("scelidosaurus_egg_incubated", () -> new PrehistoricEggBlock(BlockBehaviour.Properties.of(Material.EGG, MaterialColor.COLOR_RED).strength(0.5F).sound(SoundType.METAL).randomTicks().noOcclusion(), EntityInit.SCELIDOSAURUS, 4));
